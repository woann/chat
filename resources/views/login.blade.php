            ...
            <div class="logo_box">
                ...
                <form action="#" name="f" method="post">
                    ...
                    <div class="input_outer">
                        ...
                        <input name="username" class="text" style="color: #FFFFFF !important" type="text" placeholder="请输入账户" value="woann">
                    </div>
                    <div class="input_outer">
                        <span class="us_uer"></span>
                        <input name="password" class="text" style="color: #FFFFFF !important; position:absolute; z-index:100;"value="wqg951122" type="password" placeholder="请输入密码">
                    </div>
